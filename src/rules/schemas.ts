...
export const equipmentValidationSchema = z.object({
  ...
  extraCloseCombatSlots: z.number().default(0),
  extraCloseCombatSlotsRequireSingleHanded: z.boolean().default(false),
  extraShieldOrBucklerSlots: z.number().default(0),
  ...
  requiredAnyEquipmentItemIds: z.array(z.string()).default([]),
...
const defaultEquipmentValidation = {
  ...
  requiredAnyEquipmentItemIds: [],
  allowedFighterTypeIds: [],
  ratingModifier: 0,
...
export const fighterTypeSchema = z.object({
  ...
  maximumProfile: profileSchema.optional(),
...
export const rosterMemberSchema = z.object({
  ...
  advancesTaken: z.array(z.object({
    ...
    xpAt: z.number(),
    result: z.string(),
    tableType: z.enum(["hero", "henchman"]).optional(),
    rollDice: z.tuple([z.number(), z.number()]).optional(),
    rollTotal: z.number().optional(),
    advanceKind: z.enum(["skill", "stat", "lad"]).optional(),
    advanceLabel: z.string().optional(),
    followUpRolls: z.array(z.number()).optional(),
    selectedStat: z.enum(["M", "WS", "BS", "S", "T", "W", "I", "A", "Ld"]).optional(),
    selectedSkillId: z.string().optional(),
    selectedCastableRuleId: z.string().optional(),
    duplicateCastableDecision: z.enum(["reroll", "difficulty"]).optional(),
    ladGotTalentState: z.enum(["pending", "blocked", "queued"]).optional(),
...
export const campaignLogDetailsSchema = z.object({
  ...
  advances: z.array(z.object({
    ...
    advanceKind: z.enum(["skill", "stat", "lad"]).optional(),
    advanceLabel: z.string().optional(),
    statOptions: z.array(z.enum(["M", "WS", "BS", "S", "T", "W", "I", "A", "Ld"])).optional(),
    forcedStat: z.enum(["M", "WS", "BS", "S", "T", "W", "I", "A", "Ld"]).optional(),
    followUpRolls: z.array(z.number()).optional(),
    selectedStat: z.enum(["M", "WS", "BS", "S", "T", "W", "I", "A", "Ld"]).optional(),
    selectedSkillId: z.string().optional(),
    selectedCastableRuleId: z.string().optional(),
